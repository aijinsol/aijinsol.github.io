---
title: "[DL/CV] Sequential이 아닌 Functional API로 모델 만들기"
description: "의류 이미지 구분 DL 프로젝트 #4 - Functional API"
author: aijinsol
date: 2022-10-07
categories:
  - DeepLearning
...
위 코드를 통해 내가 구성한 모델을 그림으로 확인해볼 수 있다.
...
![fig1](/statics/posts/dl/dl-08-fig1.png){: width="300"}
...
![fig2](/statics/posts/dl/dl-08-fig2.png){: width="400"}
