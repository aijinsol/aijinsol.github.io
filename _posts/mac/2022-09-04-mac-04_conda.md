...
description: "Virtual Environmemnt setting"
author: aijinsol
date: 2022-09-04
categories:
  - MAC
...
![fig1](/statics/posts/mac/mac-04-fig1.png){: width="400"}
...
- **Step 2)** Miniforge3를 home directory에 설치한다.
    ...
    ![fig2](/statics/posts/mac/mac-04-fig2.png){: width="550"}
...
![fig7](/statics/posts/mac/mac-04-fig7.png){: width="550"}
...
![fig8](/statics/posts/mac/mac-04-fig8.png){: width="550"}
...
![fig9](/statics/posts/mac/mac-04-fig9.png){: width="550"}

{FILE_NAME}.yaml 파일 모습

![fig10](/statics/posts/mac/mac-04-fig10.png){: width="550"}

{FILE_NAME}.yaml 파일 수정 후 conda 가상환경이 잘 생성되는 모습

![fig11](/statics/posts/mac/mac-04-fig11.png){: width="550"}
