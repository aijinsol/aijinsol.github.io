...
description: "sparse representation, dense representation, word embedding"
author: aijinsol
date: 2022-06-28
categories:
  - NLP
...
![fig1](/statics/posts/nlp/nlp-01-fig1.png){: width="500"}
_(좌) sparse representation, (우) dense representation (차원의 개수를 3으로 설정)_
